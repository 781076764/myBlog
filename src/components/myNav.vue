<template>
  <div class="myNav">
    <nav class="d-flex flex-wrap justify-content-center py-4 navbar-transparent fixed-top"
      ...
      <ul class="nav nav-pills justify-content-center">
        ...
        <div class="nav-item loginIcon">
          <button class="nav-link" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel"
      ...
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasRightLabel" :class="{'text-dark':darkMode,'text-body':!darkMode}">登录信息
        </h5>
      ...
      <div class="offcanvas-body">
        ...
        <div class="user text-center" v-else-if="isLogin && !openRegister">
          ...
          <div class="userName my-2" v-if="!openChangeUserName" :class="{'text-dark':darkMode,'text-body':!darkMode}">
            {{userInfo.userName}}
